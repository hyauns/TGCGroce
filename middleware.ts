...
const SECURITY_HEADERS = {
  "Content-Security-Policy": [
    "default-src 'self'",
    `script-src 'self' 'unsafe-inline' ${!isProd ? "'unsafe-eval'" : ""} https://maps.googleapis.com https://challenges.cloudflare.com https://va.vercel-scripts.com https://widget.trustpilot.com`,
    "style-src 'self' 'unsafe-inline'",
    "img-src 'self' data: blob: https:",
    "font-src 'self' data: https://fonts.gstatic.com",
    "connect-src 'self' https://maps.googleapis.com https://challenges.cloudflare.com https://*.trustpilot.com",
