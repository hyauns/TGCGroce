...
export async function sendWelcomeEmail(
  ...
  try {
    ...
    return await sendEmailWithRetry({
      to: user.email,
      subject: "Welcome to TCG Lore Inc.!",
      html,
      text,
    })
  } catch (error) {
...
export async function sendVerificationEmail(
  ...
  try {
    ...
    return await sendEmailWithRetry({
      to: user.email,
      subject: "Verify your TCG Lore Inc. email address",
      html,
      text,
    })
  } catch (error) {
...
export async function sendPasswordResetEmail(
  ...
  try {
    ...
    return await sendEmailWithRetry({
      to: user.email,
      subject: "Reset your TCG Lore Inc. password",
      html,
      text,
    })
  } catch (error) {
...
export async function sendPasswordChangedEmail(
  ...
  try {
    ...
    return await sendEmailWithRetry({
      to: user.email,
      subject: "Password changed - TCG Lore Inc.",
      html,
      text,
    })
  } catch (error) {
